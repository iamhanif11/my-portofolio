...
function HeroSection() {
  return (
    <section className="min-h-screen flex items-center px-6 lg:px-24 py-12 overflow-hidden bg-linear-to-r from-[#11284c] to-[#020813]">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="z-10 text-center lg:text-left">
          ...
          <div className="mt-4 h-10 lg:h-15">
            <TypeAnimation
              sequence={[
                "Web Developer",
                1500,
              ...
              wrapper="h2"
              speed={50}
              className="text-primary-blue text-3xl lg:text-4xl font-extrabold "
              repeat={Infinity}
            />
          </div>

          {/* deskripsi */}
          <p className="text-text-muted text-lg mt-2 max-w-lg leading-relaxed mx-auto lg:mx-0 ">
            {PROFILE.description}
          </p>
